...
//     authorizationInfo.addStringPermission("userInfo:query");
        ...
        List<SysUserRole> sysUserRoleList=userRoleService.findById(userInfo.getId());


        for (SysUserRole sysUserRole : sysUserRoleList) {
            SysRole role=roleService.findById(sysUserRole.getRoleid());
            authorizationInfo.addRole(role.getName());
            List<SysRolePermission> sysRolePermissionList= rolePermissionService.findById(sysUserRole.getRoleid());
            for(SysRolePermission list:sysRolePermissionList){
                SysPermission sysPermission=permissionService.findById(list.getRoleid());
